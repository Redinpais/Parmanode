...
########################################################################################
    ...
    Também pode visualizá-los diretamente se se sentir à vontade para navegar no sistema de
    ficheiros do seu computador. A maioria está localizada em$cyan $HOME/.parmanode/ $orange
    (Note o \".\", não é um acidente)
...
$cyan
                     uh)$orange            Reexibir mensagens (ocultou-as com 'FREE ROSS')
$orange
